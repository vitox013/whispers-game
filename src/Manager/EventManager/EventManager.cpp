...
void Whispers::Manager::EventManager::AddObserver(Observer::Observer *pObserver)
{
    pObsList->AddObserver(pObserver);
}

void Whispers::Manager::EventManager::RemoveObserver(Observer::Observer *pObserver)
{
